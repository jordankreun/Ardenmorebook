...
**The two modes (2026-08-02, the deepest rule here).** Conventional practice **asserts a will**: find the grain, take hold, tell it what to be, and thereafter it has no say. That is the whole literature and the discipline Emlyn trained in. **Emlyn listens and negotiates** — finds what a thing already wants and gets out of its way earlier than anyone thought to. When you write any working, know which mode it is in. A conventional working is written as imposition and is allowed to be competent and cold; Emlyn's are written as attention. He arrived at his mode **alone** — never give him a teacher or a tradition for it, and never let it read as destiny (he is first to ask because he invented asking; anyone might have). Brenna's grandmother *listened*, which is perception, and did not negotiate, which is working.

**He does not explain his workings.** To a customer or a neighbour he gives the outcome and withholds the how. The reader gets the mechanism from the NARRATION, never out of his mouth.
