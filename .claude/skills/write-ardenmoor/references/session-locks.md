# SESSION-LOCKED AUTHOR DECISIONS + THE FEEDBACK PROTOCOL

### Binding in EVERY mode. Read this before anything else, every session, without exception.
### Moved out of SKILL.md 2026-07-31 when that file became a router; the text below is
### unchanged. These supersede the reference docs wherever they differ.
