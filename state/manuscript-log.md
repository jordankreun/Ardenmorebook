...
- Word count: **185,950** (prose lines only; blank lines and `#`-headers excluded). Every length
...
- **2026-08-09 — PARTS I AND II EXPANDED to roughly 2.3×** on the author's instruction, by turning
 the book's compressed summary into played scene. Ch 1–15 + both interludes, 53,632 → 126,411 words;
