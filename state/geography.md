# GEOGRAPHY & MAP — LIVING CONTINUITY RECORD

### The physical world of *The Tower of Ardenmoor*. Read before drafting; update after any
### chapter that places, names, or moves something. Keep the three tiers honest:
### **[CANON]** locked (outline appendix / story bible) — never contradict.
### **[PAGE ch N]** established in the prose — never contradict; cite the chapter.
### **[OPEN]** not yet fixed — free to invent; once you fix it in prose, promote it to [PAGE].

---

## SCHEMATIC MAP (not to scale; orientation approximate; interior village layout is [OPEN])

```
                                     N ↑
                       ░░░░  THE NORTH WOOD  ░░░░
                            ♠  the Old Oak
                        (the "Listener"; Brenna's
                         grandmother's offering tree;
                         past the north bend of the wood)
                                   ┊
                                ╱▔▔▔▔╲
...
Legend: ● water feature · ⚙ mill · ♠ the Old Oak · ▔╲╱ the hill.

---

## ORIENTATION KEY (the compass anchors — these are load-bearing)

- The **hill** lies **north, and a little east, of the village**. [PAGE ch1]
- The **north wood** and the **Old Oak** are **north of the hill** (past the wood's north
  bend). [PAGE ch2] [CANON]
- The **spring** rises on the hill's **south face**. [PAGE ch2] (Consistent with [CANON]: the
  well is sunk on the south face.)
- **The GREENHOUSE is now BUILT (Ch 15):** on the **southeast slope** (a good acre and a half of south-and-east facing hillside, sun from first light to last) — **160 ft long × 5 bays deep, with propagation houses at the cold end and a stove**; enchanted wrought-steel frame (forged in the city to Emlyn's drawings, warded against rust/rot, up the frontier road on **ELEVEN wagons**), glass hung over three weeks. **The largest structure in the valley — longer than Ardenmoor's whole street** (the 3-storey inn was the previous record). Beds planned WITH Brenna (partnership); the **cool shaded NORTH corner is kept BARE on purpose** ("leave it, I'll tell you when" — reserved, unspoken, for the keeper plant eventually; BLIND). The greenhouse is meant as the "years' bread" (earns from the ground; Brenna's trade + Emlyn's craft under one roof). [PAGE ch15]
...
A small place strung along the **beck**, thatch and grey stone, "where it is for longer than
...
- **The beck** — runs through the village; powers Maret's mill. [PAGE ch1]
...
## LANDMARKS & TREES (keep the two oaks distinct!)
...
- **The birches** — by Brenna's cottage at the lane's end. [CANON]
- **The larch stand** — in Emlyn's woodland strip. [PAGE ch2]
...
## OPEN (free to invent; promote to [PAGE] once fixed in prose)
...
- **ch2** — Established: the crown; the south-face spring; the east green shelf; the NE meadow;
  ...
  turned both down).
- **ch3** — Purchase complete. Emlyn's goods (2 wagons from Vethmark) stored in a let corner of the inn's stable (⚠️ revised 2026-07-28: wagons do NOT go up the roadless hill; books to his room; the chest waits at the stable until the Study is built); he takes Snow up and pitches a
