...
This skill is self-contained. Everything you need is in this folder:
- `references/outline.md` — the full 28-chapter outline, twist, cast, canon appendix
- `references/style-guide.md` — prose mechanics, voice, motif system, lexicon
- `references/voice-rothfuss-mancour.md` — the specific author-voice fusion for THIS book
- `references/continuity-checklist.md` — the pre-flight and post-flight checks per chapter
...
- `chapters/` — the manuscript itself, one file per chapter
...
**Write to a file.** Save as `chapters/ch-NN-slug.md` (zero-padded, e.g. `ch-07-wednesdays.md`)
with a small front-matter header: chapter number, title, POV (Opus, past tense), season/day,
word count, and the threads touched. Do NOT put the title as an in-prose heading inside the scene.
